import s from './movie-header.module.scss'
...
export const MovieHeader = ({}: SeriesHeaderProps) => {
  return (
    <header className={s.container}>
      <div className={s.coverContainer}>
        <Image src={movieCover} alt={'movieCover'} className={s.mainCover} />
      </div>
      <div className={s.captionContainer}>
        <div>
          <Image src={movieName} alt={'movieName'} className={s.movieName} />
          ...
          <Typography variant={'body3'} as={'h5'} className={s.description}>
